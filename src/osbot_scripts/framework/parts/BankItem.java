...
public class BankItem {
	...
	/**
	 * @param l the amountBeforeAction to set
	 */
	...
	/**
	 * @param withdrawNoted the withdrawNoted to set
	 */
	...
	/**
	 * @param inBankToBeSkipped the inBankToBeSkipped to set
	 */
