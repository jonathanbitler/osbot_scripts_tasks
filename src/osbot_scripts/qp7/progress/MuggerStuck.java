...
//					new Position(3190, 3363, 0), new Position(3186, 3363, 0), new Position(3186, 3361, 0)
	...
	public static void run(Script script, MethodProvider api) {
		walkExact(script, api,TEST.get(0), true);
		walkExact(script, api,TEST.get(1), true);
		walkExact(script, api,TEST.get(2), false);
		walkExact(script, api,TEST.get(3), false);
	}
